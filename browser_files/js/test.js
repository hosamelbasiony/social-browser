...
TTTTT.__define(
    ...
    new Proxy(navigator, {
        ...
        get: function (target, key, receiver) {
            ...
            return Object.hasOwn(TTTTT.navigator, key) ? TTTTT.navigator[key] : target[key];
        },
...
if (true) {
    ...
    TTTTT.__setConstValue(window.XMLHttpRequest, 'toString', () => s2);
}
...
if (false) {
    if (false) {
        ...
        TTTTT.__setConstValue(window.fetch, 'toString', () => s);
    }
...
if (!TTTTT.isWhiteSite) {
    if ((stringify0 = false)) {
        JSON.stringify0 = JSON.stringify;
        let j = JSON.stringify.toString();
        JSON.stringify = function (...args) {
            try {
                args[0] = TTTTT.cloneObject(args[0]);
                return JSON.stringify0.apply(this, args);
            } catch (error) {
                console.log(error);
        ...
        TTTTT.__setConstValue(JSON.stringify, 'toString', () => j);
    }
