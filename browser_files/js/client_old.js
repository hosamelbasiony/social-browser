(function (w, d, u) {
  var _____ = globalThis.this;
    ...
    $a.assign = $f.assign = function (p, v) {
        ...
        if (p.length > 1) {
            var e = p.shift();
            this.assign((this[e] = Object.prototype.toString.call(this[e]) === '[object Object]' ? this[e] : {}), p, v);
        } else {
            if (typeof v == u) {
    ...
    _____.imagesDisplayed = true;
    _____.toggleImages = () => {
        if (_____.imagesDisplayed) {
            ___('img').css('visibility', 'hidden');
            _____.imagesDisplayed = false;
        } else {
